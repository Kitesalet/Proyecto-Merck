    ...
    public partial class seeders : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "CEGYR Medicina Reproductiva", "Edad y Reserva Ovarica", new DateTime(2024, 1, 17, 14, 12, 50, 8, DateTimeKind.Local).AddTicks(3500), "https://ejemplo.com/" },
                    { 2, "Centro de Investigaciones en Medicina Reproductiva", "Evaluación de Reserva Ovárica", new DateTime(2024, 1, 17, 14, 12, 50, 8, DateTimeKind.Local).AddTicks(3597), "https://ejemplo2.com/" }
                });
