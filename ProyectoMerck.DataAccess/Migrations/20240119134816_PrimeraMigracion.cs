    ...
    public partial class PrimeraMigracion : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "CEGYR Medicina Reproductiva", "Edad y Reserva Ovarica", new DateTime(2024, 1, 19, 10, 48, 16, 72, DateTimeKind.Local).AddTicks(5614), "https://ejemplo.com/" },
                    { 2, "Centro de Investigaciones en Medicina Reproductiva", "Evaluación de Reserva Ovárica", new DateTime(2024, 1, 19, 10, 48, 16, 72, DateTimeKind.Local).AddTicks(5702), "https://ejemplo2.com/" }
                });
