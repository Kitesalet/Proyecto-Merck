function drawChart2(firstAge, endAge, foliName) {
    ...
    if (endAge === 0) {
        ...
        let modifiedFirstAge = firstAge - 12;
        ...
        switch (endAge) {
            case 3:
                ...
                modifiedFirstAge = firstAge - 12;
                modifiedLastAge = modifiedFirstAge + 4;

            break;

            case 6:

                modifiedFirstAge = firstAge - 9;
                modifiedLastAge = modifiedFirstAge + 4;
            ...
            case 11:
                ...
                modifiedFirstAge = firstAge - 2;
                modifiedLastAge = dataValues.length;

            break;

        }

        for (let i = modifiedFirstAge; i < modifiedLastAge ; i++) {
            selectedDataValues.push(dataValues[i]);
        }
